...
from ScalingConcept.src.renoise_inversion import inversion_step
...
class SDXLDDIMPipeline(StableDiffusionXLImg2ImgPipeline):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        return StableDiffusionXLPipelineOutput(images=image), all_latents, [prompt_embeds, added_cond_kwargs]
